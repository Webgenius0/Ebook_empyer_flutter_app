                          ...
                          Row(
                            children: [
                              Text(
                                notification["date"] ?? '',
                                style: TextFontStyle
                                    .textStyle20c2B2B2BUrbanistW400
                                    .copyWith(
                                        color: AppColors.c717171, fontSize: 14),
                              ),
                          ...
                          subtitle: Column(
                            ...
                            children: [
                              ...
                              Text(
                                ...
                                style: TextFontStyle
                                    .textStyle14c2B2B2BEUrbanistW400
                                    .copyWith(
                                  color: AppColors.c2B2B2B,
                                ),
                              ),
                              ...
                              Text(
                                notification["time"],
                                style: TextFontStyle
                                    .textStyle14c717171UrbanistW400
                                    .copyWith(
                                  ...
                                  children: [
                                    Container(
                                      ...
                                      decoration: const BoxDecoration(
                                        color: AppColors.c743DFF, // Blue color
                                        shape: BoxShape.circle,
                                      ),
                                    ),
                                    UIHelper.horizontalSpace(10.w),
                                    // SvgPicture.asset(
                                    //     Assets.icons.arrowRightNotificationSvg),
                                  ],
                                )
                              : null,
                        ),
