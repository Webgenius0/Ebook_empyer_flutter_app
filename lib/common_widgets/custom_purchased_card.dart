...
class CustomPurchasedCard extends StatelessWidget {
  ...
  const CustomPurchasedCard({
    ...
    required this.isDownloaded, // Pass the callback from outside
  });
        ...
        children: [
          ...
          Column(
            children: [
              ...
              isDownloaded
                  ? SvgPicture.asset(Assets.icons.tikBlue)
